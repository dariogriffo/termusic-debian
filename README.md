...
(.deb) for [termusic](https://github.com/tramhao/termusic/) hosted at [deb.griffo.io](https://deb.griffo.io)

<p align="center">
⭐⭐⭐ Love using termusic on Debian? Show your support by starring this repo or [subscribing](https://buy.stripe.com/aFa28q8hr0lRdlm4a2enS01) — from 1 October 2026, apt access requires a yearly subscription. ⭐⭐⭐
</p>
...
📖 **Step-by-step install guide:** [Debian](https://deb.griffo.io/install-latest-termusic-in-debian.html) · [Ubuntu](https://deb.griffo.io/install-latest-termusic-in-ubuntu.html)
...
> the .deb from the [Releases](https://github.com/dariogriffo/termusic-debian/releases) page
